...
function gymfitness_scripts_styles() {
    ...
    if(is_front_page()) {
        wp_enqueue_style('swiper-css', 'https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.css', array(), '11.2.6');
    }
    ...
    if(is_front_page()) {
        wp_enqueue_script('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js', array(), '11.2.6', true);
...
function gymfitness_widgets () {
    register_sidebar( array(
        ...
        'after_widget' => '</div>',
        'before_tittle' => '<h3 class="text-center text-primary">',
        'after_title' => '</h3>'
    ));
