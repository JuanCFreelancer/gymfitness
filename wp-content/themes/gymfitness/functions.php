...
function gymfitness_scripts_styles()
{
    ...
    wp_enqueue_script('swiper-css','https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css', array(), '11.2.6');
    ...
    wp_enqueue_script('scripts', get_template_directory_uri() . '/js/scripts.js', array('swiper-js'), '10.0.0', true);
}    
